...
/// @nodoc
@JsonSerializable()
class _$_ResponseData with DiagnosticableTreeMixin implements _ResponseData {
  const _$_ResponseData({required this.data});
...
abstract class _ResponseData implements ResponseData {
  const factory _ResponseData({required final dynamic data}) = _$_ResponseData;
